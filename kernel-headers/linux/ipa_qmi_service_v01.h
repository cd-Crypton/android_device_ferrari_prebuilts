...
struct ipa_init_modem_driver_req_msg_v01 {
  ...
  __u8 is_ssr_bootup_valid;                                                                        __u8 is_ssr_bootup;
  __u8 hdr_proc_ctx_tbl_info_valid;                                                                struct ipa_hdr_proc_ctx_tbl_info_type_v01 hdr_proc_ctx_tbl_info;
  __u8 zip_tbl_info_valid;                                                                         struct ipa_zip_tbl_info_type_v01 zip_tbl_info;
...
struct ipa_install_fltr_rule_req_msg_v01 {
  ...
  __u32 num_ipv6_filters;                                                                          __u8 xlat_filter_indices_list_valid;                                                             __u32 xlat_filter_indices_list_len;
  __u32 xlat_filter_indices_list[QMI_IPA_MAX_FILTERS_V01];                                         __u8 filter_spec_ex_list_valid;                                                                  __u32 filter_spec_ex_list_len;
  struct ipa_filter_spec_ex_type_v01 filter_spec_ex_list[QMI_IPA_MAX_FILTERS_V01];                 __u8 filter_spec_ex2_list_valid;                                                                 __u32 filter_spec_ex2_list_len;
  struct ipa_filter_spec_ex2_type_v01 filter_spec_ex2_list[QMI_IPA_MAX_FILTERS_V01];               __u8 ul_firewall_indices_list_valid;
  __u32 ul_firewall_indices_list_len;
  __u32 ul_firewall_indices_list[QMI_IPA_MAX_FILTERS_V01];                                       };                                                                                               struct ipa_filter_rule_identifier_to_handle_map_v01 {
  __u32 filter_spec_identifier;                                                                    __u32 filter_handle;
};                                                                                               struct ipa_install_fltr_rule_resp_msg_v01 {                                                        struct ipa_qmi_response_type_v01 resp;                                                           __u8 filter_handle_list_valid;                                                                   __u32 filter_handle_list_len;                                                                    struct ipa_filter_rule_identifier_to_handle_map_v01 filter_handle_list[QMI_IPA_MAX_FILTERS_V01];                                                                                                  __u8 rule_id_valid;                                                                              __u32 rule_id_len;                                                                               __u32 rule_id[QMI_IPA_MAX_FILTERS_V01];                                                        };
struct ipa_filter_handle_to_index_map_v01 {                                                        __u32 filter_handle;                                                                             __u32 filter_index;                                                                            };                                                                                               struct ipa_fltr_installed_notif_req_msg_v01 {
  __u32 source_pipe_index;                                                                         enum ipa_qmi_result_type_v01 install_status;
  __u32 filter_index_list_len;                                                                     struct ipa_filter_handle_to_index_map_v01 filter_index_list[QMI_IPA_MAX_FILTERS_V01];            __u8 embedded_pipe_index_valid;                                                                  __u32 embedded_pipe_index;
  __u8 retain_header_valid;                                                                        __u8 retain_header;
  __u8 embedded_call_mux_id_valid;                                                                 __u32 embedded_call_mux_id;
  __u8 num_ipv4_filters_valid;                                                                     __u32 num_ipv4_filters;
  __u8 num_ipv6_filters_valid;                                                                     __u32 num_ipv6_filters;                                                                          __u8 start_ipv4_filter_idx_valid;                                                                __u32 start_ipv4_filter_idx;
  __u8 start_ipv6_filter_idx_valid;                                                                __u32 start_ipv6_filter_idx;                                                                     __u8 rule_id_valid;
  __u32 rule_id_len;                                                                               __u32 rule_id[QMI_IPA_MAX_FILTERS_V01];                                                          __u8 dst_pipe_id_valid;
  __u32 dst_pipe_id_len;                                                                           __u32 dst_pipe_id[QMI_IPA_MAX_CLIENT_DST_PIPES_V01];
...
struct ipa_get_data_stats_req_msg_v01 {                                                            enum ipa_stats_type_enum_v01 ipa_stats_type;                                                     __u8 reset_stats_valid;
  __u8 reset_stats;                                                                              };                                                                                               struct ipa_get_data_stats_resp_msg_v01 {
  struct ipa_qmi_response_type_v01 resp;                                                           __u8 ipa_stats_type_valid;                                                                       enum ipa_stats_type_enum_v01 ipa_stats_type;
  __u8 ul_src_pipe_stats_list_valid;                                                               __u32 ul_src_pipe_stats_list_len;
  struct ipa_pipe_stats_info_type_v01 ul_src_pipe_stats_list[QMI_IPA_MAX_PIPES_V01];
  __u8 dl_dst_pipe_stats_list_valid;                                                               __u32 dl_dst_pipe_stats_list_len;                                                                struct ipa_pipe_stats_info_type_v01 dl_dst_pipe_stats_list[QMI_IPA_MAX_PIPES_V01];
  __u8 dl_filter_rule_stats_list_valid;                                                            __u32 dl_filter_rule_stats_list_len;
  struct ipa_stats_type_filter_rule_v01 dl_filter_rule_stats_list[QMI_IPA_MAX_FILTERS_V01];      };                                                                                               struct ipa_apn_data_stats_info_type_v01 {                                                          __u32 mux_id;                                                                                    __u64 num_ul_packets;                                                                            __u64 num_ul_bytes;
  __u64 num_dl_packets;                                                                            __u64 num_dl_bytes;                                                                            };                                                                                               struct ipa_get_apn_data_stats_req_msg_v01 {                                                        __u8 mux_id_list_valid;
  __u32 mux_id_list_len;                                                                           __u32 mux_id_list[QMI_IPA_MAX_APN_V01];                                                        };                                                                                               struct ipa_get_apn_data_stats_resp_msg_v01 {                                                       struct ipa_qmi_response_type_v01 resp;
  __u8 apn_data_stats_list_valid;                                                                  __u32 apn_data_stats_list_len;
  struct ipa_apn_data_stats_info_type_v01 apn_data_stats_list[QMI_IPA_MAX_APN_V01];              };                                                                                               struct ipa_data_usage_quota_info_type_v01 {                                                        __u32 mux_id;
  __u64 num_Mbytes;                                                                              };
#define IPA_DATA_WARNING_QUOTA                                                                   struct ipa_set_data_usage_quota_req_msg_v01 {
  __u8 apn_quota_list_valid;                                                                       __u32 apn_quota_list_len;
  struct ipa_data_usage_quota_info_type_v01 apn_quota_list[QMI_IPA_MAX_APN_V01];                   __u8 apn_warning_list_valid;                                                                     __u32 apn_warning_list_len;                                                                      struct ipa_data_usage_quota_info_type_v01 apn_warning_list[QMI_IPA_MAX_APN_V01];
};                                                                                               struct ipa_set_data_usage_quota_resp_msg_v01 {                                                     struct ipa_qmi_response_type_v01 resp;
};                                                                                               struct ipa_data_usage_quota_reached_ind_msg_v01 {                                                  struct ipa_data_usage_quota_info_type_v01 apn;
  __u8 is_warning_limit_valid;                                                                     __u8 is_warning_limit;
};
