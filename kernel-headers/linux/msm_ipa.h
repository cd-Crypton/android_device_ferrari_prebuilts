...
#define IPAHAL_NAT_INVALID_PROTOCOL 0xFF                                                         #define IPA_IOCTL_ADD_HDR 0
...
#define IPA_FLT_DST_PORT_RANGE (1ul << 5)                                                        #define IPA_FLT_TYPE (1ul << 6)
#define IPA_FLT_CODE (1ul << 7)                                                                  #define IPA_FLT_SPI (1ul << 8)
#define IPA_FLT_SRC_PORT (1ul << 9)                                                              #define IPA_FLT_DST_PORT (1ul << 10)
...
#define IPA_COALESCE_EVENT_MAX IPA_COALESCE_EVENT_MAX                                            };                                                                                               enum ipa_mtu_event {
  IPA_SET_MTU = IPA_COALESCE_EVENT_MAX,                                                            IPA_MTU_EVENT_MAX                                                                              #define IPA_MTU_EVENT_MAX IPA_MTU_EVENT_MAX
};                                                                                               enum ipa_peripheral_event {                                                                        IPA_PERIPHERAL_CONNECT = ECM_CONNECT,
  IPA_PERIPHERAL_DISCONNECT = ECM_DISCONNECT                                                     };
#define WIGIG_CLIENT_CONNECT (IPA_MTU_EVENT_MAX)
#define WIGIG_FST_SWITCH (WIGIG_CLIENT_CONNECT + 1)                                              #define WIGIG_EVENT_MAX (WIGIG_FST_SWITCH + 1)                                                   enum ipa_pdn_config_event {
  IPA_PDN_DEFAULT_MODE_CONFIG = WIGIG_EVENT_MAX,                                                   IPA_PDN_IP_COLLISION_MODE_CONFIG,
  IPA_PDN_IP_PASSTHROUGH_MODE_CONFIG,                                                              IPA_PDN_CONFIG_EVENT_MAX                                                                       #define IPA_PDN_CONFIG_EVENT_MAX IPA_PDN_CONFIG_EVENT_MAX                                        };                                                                                               enum ipa_mac_flt_event {                                                                           IPA_MAC_FLT_EVENT = IPA_PDN_CONFIG_EVENT_MAX,
  IPA_MAC_FLT_EVENT_MAX                                                                          #define IPA_MAC_FLT_EVENT_MAX IPA_MAC_FLT_EVENT_MAX                                              };                                                                                               enum ipa_sockv5_event {                                                                            IPA_SOCKV5_ADD = IPA_MAC_FLT_EVENT_MAX,
  IPA_SOCKV5_DEL,                                                                                  IPA_SOCKV5_EVENT_MAX                                                                           #define IPA_SOCKV5_EVENT_MAX IPA_SOCKV5_EVENT_MAX                                                };                                                                                               enum ipa_warning_limit_event {
  IPA_WARNING_LIMIT_REACHED = IPA_SOCKV5_EVENT_MAX,                                                IPA_WARNING_LIMIT_EVENT_MAX,
#define IPA_WARNING_LIMIT_EVENT_MAX IPA_WARNING_LIMIT_EVENT_MAX                                  };                                                                                               enum ipa_sw_flt_event {                                                                            IPA_SW_FLT_EVENT = IPA_WARNING_LIMIT_EVENT_MAX,
  IPA_SW_FLT_EVENT_MAX                                                                           #define IPA_SW_FLT_EVENT_MAX IPA_SW_FLT_EVENT_MAX
};                                                                                               enum ipa_pkt_threshold_event {
  IPA_PKT_THRESHOLD_EVENT = IPA_SW_FLT_EVENT_MAX,                                                  IPA_PKT_THRESHOLD_EVENT_MAX
#define IPA_PKT_THRESHOLD_EVENT_MAX IPA_PKT_THRESHOLD_EVENT_MAX                                  };                                                                                               enum ipa_move_nat_table_event {                                                                    IPA_MOVE_NAT_TABLE = IPA_PKT_THRESHOLD_EVENT_MAX,
  IPA_MOVE_NAT_EVENT_MAX                                                                         #define IPA_MOVE_NAT_EVENT_MAX IPA_MOVE_NAT_EVENT_MAX                                            };
enum ipa_eogre_event {                                                                             IPA_EoGRE_UP_EVENT = IPA_MOVE_NAT_EVENT_MAX,                                                     IPA_EoGRE_DOWN_EVENT,
  IPA_EoGRE_EVENT_MAX                                                                            #define IPA_EoGRE_EVENT_MAX IPA_EoGRE_EVENT_MAX
};
...
struct ipa_ioc_macsec_info {
  ...
  __u32 ioctl_data_size;
  __u32 padding;
};                                                                                               #define IPA_IOC_ADD_HDR _IOWR(IPA_IOC_MAGIC, IPA_IOCTL_ADD_HDR, struct ipa_ioc_add_hdr *)        #define IPA_IOC_DEL_HDR _IOWR(IPA_IOC_MAGIC, IPA_IOCTL_DEL_HDR, struct ipa_ioc_del_hdr *)
...
#define IPA_IOC_ADD_RT_RULE_EXT _IOWR(IPA_IOC_MAGIC, IPA_IOCTL_ADD_RT_RULE_EXT, struct ipa_ioc_add_rt_rule_ext *)                                                                                 #define IPA_IOC_ADD_RT_RULE_EXT_V2 _IOWR(IPA_IOC_MAGIC, IPA_IOCTL_ADD_RT_RULE_EXT_V2, struct ipa_ioc_add_rt_rule_ext_v2 *)
...
#define IPA_IOC_DEL_MACSEC_MAPPING _IOWR(IPA_IOC_MAGIC, IPA_IOCTL_DEL_MACSEC_MAPPING, struct ipa_ioc_macsec_info)                                                                                 #define TETH_BRIDGE_IOC_MAGIC 0xCE                                                               #define TETH_BRIDGE_IOCTL_SET_BRIDGE_MODE 0                                                      #define TETH_BRIDGE_IOCTL_SET_AGGR_PARAMS 1                                                      #define TETH_BRIDGE_IOCTL_GET_AGGR_PARAMS 2
#define TETH_BRIDGE_IOCTL_GET_AGGR_CAPABILITIES 3                                                #define TETH_BRIDGE_IOCTL_MAX 4                                                                  enum teth_link_protocol_type {                                                                     TETH_LINK_PROTOCOL_IP,                                                                           TETH_LINK_PROTOCOL_ETHERNET,                                                                     TETH_LINK_PROTOCOL_MAX,
};                                                                                               enum teth_aggr_protocol_type {
  TETH_AGGR_PROTOCOL_NONE,                                                                         TETH_AGGR_PROTOCOL_MBIM,
  TETH_AGGR_PROTOCOL_TLP,                                                                          TETH_AGGR_PROTOCOL_MAX,                                                                        };                                                                                               struct teth_aggr_params_link {                                                                     enum teth_aggr_protocol_type aggr_prot;                                                          uint32_t max_transfer_size_byte;                                                                 uint32_t max_datagrams;
};                                                                                               struct teth_aggr_params {                                                                          struct teth_aggr_params_link ul;                                                                 struct teth_aggr_params_link dl;                                                               };                                                                                               struct teth_aggr_capabilities {
  uint16_t num_protocols;                                                                          struct teth_aggr_params_link prot_caps[0];
};
struct teth_ioc_set_bridge_mode {
  enum teth_link_protocol_type link_protocol;                                                      uint16_t lcid;                                                                                 };                                                                                               struct teth_ioc_aggr_params {                                                                      struct teth_aggr_params aggr_params;                                                             uint16_t lcid;                                                                                 };                                                                                               struct ipa_nat_in_sram_info {                                                                      uint32_t sram_mem_available_for_nat;                                                             uint32_t nat_table_offset_into_mmap;                                                             uint32_t best_nat_in_sram_size_rqst;                                                           };                                                                                               enum ipa_app_clock_vote_type {                                                                     IPA_APP_CLK_DEVOTE = 0,
  IPA_APP_CLK_VOTE = 1,                                                                            IPA_APP_CLK_RESET_VOTE = 2,
};                                                                                               #define TETH_BRIDGE_IOC_SET_BRIDGE_MODE _IOW(TETH_BRIDGE_IOC_MAGIC, TETH_BRIDGE_IOCTL_SET_BRIDGE_MODE, struct teth_ioc_set_bridge_mode *)                                                         #define TETH_BRIDGE_IOC_SET_AGGR_PARAMS _IOW(TETH_BRIDGE_IOC_MAGIC, TETH_BRIDGE_IOCTL_SET_AGGR_PARAMS, struct teth_ioc_aggr_params *)                                                             #define TETH_BRIDGE_IOC_GET_AGGR_PARAMS _IOR(TETH_BRIDGE_IOC_MAGIC, TETH_BRIDGE_IOCTL_GET_AGGR_PARAMS, struct teth_ioc_aggr_params *)                                                             #define TETH_BRIDGE_IOC_GET_AGGR_CAPABILITIES _IOWR(TETH_BRIDGE_IOC_MAGIC, TETH_BRIDGE_IOCTL_GET_AGGR_CAPABILITIES, struct teth_aggr_capabilities *)                                              #define ODU_BRIDGE_IOC_MAGIC 0xCD                                                                #define ODU_BRIDGE_IOCTL_SET_MODE 0                                                              #define ODU_BRIDGE_IOCTL_SET_LLV6_ADDR 1                                                         #define ODU_BRIDGE_IOCTL_MAX 2                                                                   enum odu_bridge_mode {
  ODU_BRIDGE_MODE_ROUTER,                                                                          ODU_BRIDGE_MODE_BRIDGE,
  ODU_BRIDGE_MODE_MAX,
};
